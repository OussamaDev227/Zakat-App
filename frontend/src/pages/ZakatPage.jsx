...
export default function ZakatPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">حساب الزكاة</h1>
        <p className="text-gray-600">إدارة حسابات الزكاة للشركة بناءً على القواعد الشرعية المطبقة</p>
        ...
        <div className="space-y-6">
              ...
              <div className="flex justify-between items-start">
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    <h2 className="text-xl font-bold text-gray-900">اسم الشركة:</h2>
                    <span className="text-blue-700 text-xl">{calculation.company_name || activeCompany.name}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <h2 className="text-lg font-bold text-gray-900">نوع الشركة:</h2>
                    <span className="text-gray-700">{formatCompanyType(calculation.company_type)}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <h2 className="text-lg font-bold text-gray-900">السنة المالية:</h2>
              ...
              <div className="flex gap-3 pt-4 border-t border-blue-300">
                ...
                {false && (
                  <button
                    ...
                    className={`btn-secondary ${generatingPDF ? 'opacity-50 cursor-not-allowed' : ''}`}
          ...
          <div className="card border-2 border-blue-200">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-gray-900">البنود المدرجة في هذا الحساب</h2>
              {isDraft && (
                <button
            ...
            {showItemSelector && (
              <div className="mt-4 p-4 bg-gray-50 border-2 border-gray-300 rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-bold text-gray-900">اختر بند مالي لإضافته</h3>
                  <button
                ...
                {availableItems.length === 0 ? (
                  <p className="text-gray-700">لا توجد بنود مالية متاحة</p>
                ) : (
            ...
            {editingAmountItem && (
              <div className="mt-4 p-4 bg-gray-50 border-2 border-gray-300 rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-bold text-gray-900">تعديل المبلغ</h3>
                  <button
                    onClick={() => {
                      setEditingAmountItem(null);
                      setNewAmount('');
            ...
            <div className="card bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-5 border-2 border-green-200 shadow-md">
                  <p className="text-sm text-gray-700 mb-2 font-semibold">إجمالي الأصول الزكوية</p>
                  <p className="text-3xl font-bold text-green-700">
                    {totalZakatableAssets.toLocaleString('en-US', { minimumFractionDigits: 2 })} <span className="text-xl">د.ج</span>
                  </p>
                </div>
                <div className="bg-white rounded-lg p-5 border-2 border-green-200 shadow-md">
                  <p className="text-sm text-gray-700 mb-2 font-semibold">إجمالي الالتزامات القابلة للخصم</p>
                  <p className="text-3xl font-bold text-green-700">
                    {totalDeductibleLiabilities.toLocaleString('en-US', { minimumFractionDigits: 2 })} <span className="text-xl">د.ج</span>
                  </p>
                </div>
                <div className="bg-white rounded-lg p-5 border-2 border-green-200 shadow-md">
          ...
          {calculation.rules_used && calculation.rules_used.length > 0 && (
            <div className="card border-2 border-purple-200">
              <h2 className="text-xl font-bold mb-4 text-gray-900">القواعد المطبقة في هذا الحساب</h2>
              <div className="table-container">
                <table>
                  <thead>
                    <tr>
